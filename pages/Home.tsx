      ...
      >
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <span className="text-[8px] font-black uppercase tracking-[0.3em] text-indigo-100 mt-2">
              Code Integrity
            </span>
          </div>
        </motion.div>
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="text-center mb-24">
          <span className="text-indigo-500 font-black tracking-[0.3em] text-[11px] uppercase mb-8 block">
            Architecture Audit
          </span>
          <h2
            id="audit-heading"
          ...
          <p className="mt-8 text-slate-500 max-w-2xl mx-auto font-medium leading-relaxed">
            ...
            infrastructure. My portfolio itself is the benchmark for the quality
              ...
              <div className="relative w-32 h-32 mb-8">
                ...
                >
                  ...
                  <motion.circle
                    ...
                    whileInView={{
                      strokeDashoffset:
                        CIRCUMFERENCE * (1 - metric.score / 100),
                    }}
                    viewport={{ once: true }}
                    transition={{
                      duration: 2,
        ...
        <div className="mt-20 flex flex-wrap justify-center gap-12 border-t border-white/5 pt-20">
          <div
            ...
            aria-label="Max Load Speed: Sub 1s LCP Response"
          >
            <div
              className="w-12 h-12 rounded-xl bg-indigo-600/20 flex items-center justify-center text-indigo-400"
              aria-hidden="true"
            >
              <svg
                className="w-6 h-6"
          ...
          <div
            className="flex items-center space-x-4"
            aria-label="Enterprise Security: SSL & CSP Hardened"
          >
            <div
              className="w-12 h-12 rounded-xl bg-purple-600/20 flex items-center justify-center text-purple-400"
              aria-hidden="true"
            >
              <svg
                className="w-6 h-6"
          ...
          <div
            className="flex items-center space-x-4"
            aria-label="SEO Dominance: SSR & Semantic Core"
          >
            <div
              className="w-12 h-12 rounded-xl bg-amber-600/20 flex items-center justify-center text-amber-400"
              aria-hidden="true"
            >
              <svg
                className="w-6 h-6"
...
const Home: React.FC = () => {
  ...
  const FAQS = [
    {
      q: "What is your typical tech stack for building websites?",
      a: "I specialize in building high-performance, scalable web applications using React, TypeScript, and Tailwind CSS. For animations and a premium user experience, I use Framer Motion. This stack ensures your site is modern, type-safe, and incredibly fast.",
    },
    {
      q: "How long does a project usually take to complete?",
      a: "Timeline depends on the complexity of the project. A standard landing page or portfolio usually takes 1–2 weeks, while more complex web applications might take 4–6 weeks. I provide a clear roadmap and regular updates throughout the process.",
    },
    {
      q: "Can you handle the design, or do I need to provide one?",
      a: "I can work both ways! If you have a Figma or Adobe XD design, I can convert it into a pixel-perfect responsive website. If you don't have a design, I can create a clean, modern interface for you that aligns with your brand and focuses on user experience.",
    },
    {
      q: "Will my website be SEO-friendly and work on all devices?",
      a: "Yes, 100%. Every site I build is mobile-responsive, meaning it looks great on phones, tablets, and desktops. I also follow SEO best practices, such as using semantic HTML, optimizing images, and ensuring fast load times to help you rank better on search engines.",
    },
    {
      q: "Do you offer support or maintenance after the site is live?",
      a: "Definitely. I don't just build and disappear. I offer a post-launch support period to ensure everything is running smoothly. For clients who need long-term help, I also offer maintenance packages for updates, security, and performance checks.",
    },
  ];
  ...
  return (
    <div className="relative overflow-hidden bg-slate-950">
      ...
      <section
        className="relative min-h-screen flex items-center justify-center px-4 pt-24 lg:pt-0"
      ...
      >
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
          ...
          >
            ...
            <h1
              id="hero-heading"
              className="text-7xl md:text-9xl font-black tracking-tighter text-white mb-8 leading-[0.8] mix-blend-difference"
            >
              SAIF UL <br />
              <motion.span
            ...
            <p className="text-slate-400 mb-12 max-w-lg">
              Your vision, engineered into a pixel-perfect digital reality. I
              build scalable frontend architectures that look beautiful and
              perform flawlessly.
            </p>
            <div className="flex flex-col sm:flex-row gap-6">
              <Link
                to="/projects"
                className="group relative px-12 py-6 bg-white text-slate-950 rounded-full font-black overflow-hidden hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring-4 focus:ring-indigo-500 transition-all duration-500 flex items-center justify-center"
              >
              ...
              <Link
                to="/contact"
                className="px-12 py-6 border border-white/10 hover:border-white/40 text-white rounded-full font-black uppercase tracking-widest text-xs transition-all flex items-center justify-center focus:outline-none focus:ring-4 focus:ring-white/20"
              >
                Direct Connection
              </Link>
            </div>
      ...
      <div
        className="relative py-12 border-y border-white/5 bg-slate-950 overflow-hidden"
        role="marquee"
        aria-label="Key themes: Next-Gen Systems, Saif Ul Islam, UI Engineering"
      >
        <div className="flex space-x-24 whitespace-nowrap animate-scroll">
          {[...Array(10)].map((_, i) => (
            <div
              key={i}
              className="flex items-center space-x-8 text-[10px] font-black uppercase tracking-[0.4em] text-white/20 italic"
              aria-hidden="true"
            >
      ...
      <section
        className="py-40 bg-slate-900/50"
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
            ...
            <p className="text-slate-400 max-w-xs font-medium text-sm leading-relaxed">
              Standardizing excellence through a modular approach to web
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {SERVICES.slice(0, 6).map((service, i) => (
              ...
              >
                <div
                  className="absolute top-0 right-0 w-32 h-32 bg-indigo-600/10 rounded-bl-full group-hover:bg-indigo-600/20 transition-all"
                  aria-hidden="true"
                />
                ...
                <div className="mt-10 flex justify-between items-center relative z-10">
                  ...
                  <Link
                    to="/contact"
                    className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center group-hover:bg-indigo-600 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500"
      ...
      >
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mt-20 text-center">
            <Link
              to="/projects"
              className="inline-block px-12 py-6 border border-white/10 rounded-full text-white font-black uppercase tracking-widest text-xs hover:bg-white hover:text-slate-950 transition-all focus:outline-none focus:ring-4 focus:ring-white/20"
            >
              View All Systems
            </Link>
          </div>
      ...
      <section
        className="py-40 bg-slate-900/30"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {PRICING_TIERS.map((tier) => (
              <motion.div
                key={tier.id}
                whileHover={{ y: -10 }}
                className={`p-12 rounded-[4rem] border ${
                  tier.isPopular
              ...
              >
                ...
                <p className="text-sm text-indigo-100/70 font-medium mb-10 flex-grow">
                  {tier.description}
                </p>
                <ul
                  className="space-y-4 mb-12"
                  role="list"
                  aria-label={`Features for ${tier.name}`}
                >
                  {tier.features.map((f) => (
                    <li
                      key={f}
                      className="flex items-center space-x-3 text-xs font-bold text-white/80"
                    >
                      <svg
                ...
                <Link
                  to="/contact"
                  className={`w-full py-5 rounded-2xl text-center text-xs font-black uppercase tracking-widest transition-all focus:outline-none focus:ring-4 focus:ring-white/50 ${
                    tier.isPopular
      ...
      <section className="py-40 bg-slate-950" aria-labelledby="blog-heading">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
            ...
            <Link
              to="/blog"
              className="text-indigo-400 font-black text-xs uppercase tracking-widest border-b border-indigo-400/30 pb-2 focus:outline-none focus:border-white"
            >
              All Articles
            </Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {BLOG_POSTS.slice(0, 3).map((post, i) => (
              <motion.div
                ...
                tabIndex={0}
                onKeyDown={(e) =>
                  e.key === "Enter" && navigate(post.url || "/blog")
                }
                role="link"
          ...
          <div className="space-y-8" role="list">
            {FAQS.map((faq, i) => (
              <div key={i} className="group" role="listitem">
                ...
                >
                  <span className="text-2xl font-black text-white/50 group-hover:text-white transition-colors tracking-tight">
                    {faq.q}
                  </span>
                  <motion.div
                    animate={{ rotate: activeFAQ === i ? 45 : 0 }}
                    className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center group-hover:border-indigo-500 transition-all"
                    aria-hidden="true"
                  >
                    <svg
                ...
                <AnimatePresence>
                  {activeFAQ === i && (
                    ...
                    >
                      <p className="py-8 text-slate-400 font-medium leading-relaxed text-lg border-b border-white/10">
                        {faq.a}
                      </p>
                    </motion.div>
                  )}
